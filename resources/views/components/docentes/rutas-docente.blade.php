<div class="flex flex-col items-start gap-y-6">
    ...
    <div class="flex flex-col items-start w-full gap-y-1 divide-zinc-200 divide-y">
        <p class="ml-3 text-sm text-zinc-400 font-semibold tracking-wide">Capacitaciones</p>
        <div class="px-2 flex flex-col items-start w-full gap-y-1 pt-1">
    ...
    <div class="flex flex-col items-start w-full gap-y-1 divide-zinc-200 divide-y">
        <p class="ml-3 text-sm text-zinc-400 font-semibold tracking-wide">Reconocidos y Ascendidos</p>
        <div class="px-2 flex flex-col items-start w-full gap-y-1 pt-1">
    ...
    <div class="flex flex-col items-start w-full gap-y-1 divide-zinc-200 divide-y">
        <p class="ml-3 text-sm text-zinc-400 font-semibold tracking-wide">Administrativos</p>
        <div class="px-2 flex flex-col items-start w-full gap-y-1 pt-1">
