<div class="relative my-auto pt-2">
    <div class="flex mb-2 items-center justify-between">
        <div class="text-sm font-semibold inline-block py-1 px-3 rounded-full text-zinc-600 bg-zinc-100">
            {{ $slot }}
        </div>
    ...
    <div class="overflow-hidden h-3 mb-4 text-xs flex rounded bg-zinc-100">
