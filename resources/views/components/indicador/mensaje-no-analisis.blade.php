<div class="flex flex-col gap-y-4 items-center w-1/3 text-center mx-auto my-6">

    <svg class="text-gray-400" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    ...
    <p class="text-gray-600 text-sm">
        Comienze a crear mediciones según la frecuencia de medición establecido.
    </p>
