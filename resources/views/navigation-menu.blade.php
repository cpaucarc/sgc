<nav x-data="{ open: false }" class="bg-black border-b border-black print:hidden sticky z-30">
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-[60px]">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden sm:-my-px sm:ml-6 sm:flex print:hidden">
            ...
            <div class="-mr-2 flex items-center sm:hidden print:hidden">
                <button @click="open = ! open"
                    ...
                    <svg class="icon-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
