            ...
            @slot('content')
                <div class="w-full flex items-end justify-between mb-3">
                    ...
                    <div class="flex flex-col items-end w-52 space-y-2">
                        <buttons
                            class="inline-flex items-center text-{{ $solicitudSeleccionado->estado->color }}-700 bg-{{ $solicitudSeleccionado->estado->color }}-100 rounded-md text-sm px-3 py-1">
