                        ...
                        <x-utils.tables.row>
                            ...
                            <x-utils.tables.body>
                                <x-utils.buttons.danger class="text-sm"
                                                        onclick="eliminarRol('{{ $rol->name }}', {{ $rol->id }})">
                ...
                @slot('body')
                    @foreach($usuario->entidades as $i => $entidad)
                        <x-utils.tables.row>
                            ...
                            <x-utils.tables.body>
                                <x-utils.buttons.danger class="text-sm"
                                                        onclick="eliminarEntidad({{ $entidad->id }}, '{{ $entidad->nombre }}', '{{ $entidad->rol->name }}')">
                                    <x-icons.delete class="h-4 w-4"/>
                                </x-utils.buttons.danger>
                            </x-utils.tables.body>
                        </x-utils.tables.row>
                ...
                <div class="grid grid-cols-2 gap-x-4 items-start">
                    ...
                    <section class="border border-zinc-300 divide-y divide-zinc-300 rounded-md text-zinc-700">
                        <header class="px-3 py-2 rounded-t-md bg-stone-100">
                            <h2 class="font-bold text-zinc-600 mr-1">Sección de Roles</h2>
                            <p class="text-sm">
