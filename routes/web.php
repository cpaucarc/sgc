...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('admin')->controller(AdminController::class)->group(function () {
        ...
        Route::get('indicador/ver/{id}', 'indicador')->name('admin.panel.indicadores.indicador');
    ...
    Route::prefix('tpu')->controller(TituloProfesionalController::class)->group(function () {
        ...
        Route::get('solicitud/tesis/{tesis}', 'seeTesis')->name('tpu.seeTesis');
    ...
    Route::prefix('docente')->controller(DocenteController::class)->group(function () {
        ...
        Route::get('capacitados', 'docentes_capacitados')->name('docente.capacitados');
        Route::get('reconocidos', 'docentes_reconocidos')->name('docente.reconocidos');
        Route::get('ascendidos', 'docentes_ascendidos')->name('docente.ascendidos');
        Route::get('administrativos', 'demanda_administrativos')->name('docente.administrativos');
    });
